...
export const categories: Category[] = [
  { name: 'Random Tools', icon: 'wheel', slug: 'random', tools: [
    ...
    { title: 'Image Picker', slug: 'image-picker', icon: 'image', description: 'Pick students by their photos or avatars displayed in a visual grid layout.', category: 'Random Tools', route: '/image-picker' },
  ] },
